...
public class HttpNicknameToEmail extends Activity {
    ...
    public class sendTask extends AsyncTask<String, Void, String> {
        public String doInBackground(String... strings) {
            try {
                Ip i = new Ip();
                String ip = i.getIP();
                String url = "http://"+ip+":8080/TripMateServer/User/NicknameToEmail.jsp";
    ...
    public String parsedData(String recvMsg){
        ...
        try {
            jarray = new JSONObject(recvMsg).getJSONArray("nicknameToEmail");
            JSONObject jsonObject = jarray.getJSONObject(0);
            String receiveMsg = jsonObject.getString("email");
            return receiveMsg;
