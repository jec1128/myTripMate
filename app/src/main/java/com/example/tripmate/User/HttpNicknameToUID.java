...
public class HttpNicknameToUID extends Activity {
    ...
    public class sendTask extends AsyncTask<String, Void, String> {
        public String doInBackground(String... strings) {
            try {
                Ip i = new Ip();
                String ip = i.getIP();
                String url = "http://"+ip+":8080/TripMateServer/User/NicknameToUid.jsp";
    ...
    public String parsedData(String recvMsg){
        ...
        try {
            jarray = new JSONObject(recvMsg).getJSONArray("nickname-to-uid");
            JSONObject jsonObject = jarray.getJSONObject(0);
            String receiveMsg = jsonObject.getString("uid");
            return receiveMsg;
