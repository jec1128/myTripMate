...
public class HttpUserUpdate extends Activity {
    ...
    public class sendTask extends AsyncTask<String, Void, String> {
        public String doInBackground(String... strings) {
            try {
                Ip i = new Ip();
                String ip = i.getIP();
                String url = "http://"+ip+":8080/TripMateServer/User/Update.jsp";
               //String url = "http://192.168.214.146:8080/TripMateServer/User/Register.jsp";
                ...
                try {
                    ...
                    String sendmsg = "currentnickname=" + strings[0]+"&nextnickname="+strings[1]+"&password="+strings[2];
                    os.write(sendmsg);
                    os.flush();
                    os.close();
