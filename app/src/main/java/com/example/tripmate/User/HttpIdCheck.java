...
public class HttpIdCheck extends Activity {
    ...
    public class sendTask extends AsyncTask<String, Void, String> {
        public String doInBackground(String... strings) {
            try {
                Ip i = new Ip();
                String ip = i.getIP();
                String url = "http://"+ip+":8080/TripMateServer/User/ReceiveUserId.jsp";
    ...
    public String parsedData(String recvMsg){
        ...
        try {
            jarray = new JSONObject(recvMsg).getJSONArray("id-duplication");
