...
public class BoardUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date_start = (EditText) findViewById(R.id.BoardUpdateActivity_edittext_date_start);
        ...
        time_start = (EditText) findViewById(R.id.BoardUpdateActivity_edittext_time_start);
        ...
        time_end = (EditText) findViewById(R.id.BoardUpdateActivity_edittext_time_end);
