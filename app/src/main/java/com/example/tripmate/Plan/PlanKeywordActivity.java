...
import com.example.tripmate.Main.KeywordListAdapter;
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        for(int i = 0; i < arraylist.size(); i++) {
                            adapter.addItem(arraylist.get(i).getTitle(),arraylist.get(i).getAddress1(),arraylist.get(i).getAddress2(),arraylist.get(i).getImgURL(),arraylist.get(i).getTitle(), arraylist.get(i).getMapX(), arraylist.get(i).getMapY());
                        }
