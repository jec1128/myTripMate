...
public class UpdateListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //여행지
        plan_place = (EditText) findViewById(R.id.plan_et_place);
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if("success".equals(result)){
                        ...
                        listAdapter  = new PlanListAdapter(data.getList(nickname));
                        finish();
                    }
        ...
        //액티비티 종료
        close = (ImageButton)findViewById(R.id.plan_imgbt_close);
