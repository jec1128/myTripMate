...
public class fragmentChatroom extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView)view.findViewById(R.id.chatroomfragment_recyclerview);
        recyclerView.setLayoutManager(new LinearLayoutManager(inflater.getContext()));
        recyclerView.setAdapter(new ChatroomFragmentRecyclerViewAdapter());
